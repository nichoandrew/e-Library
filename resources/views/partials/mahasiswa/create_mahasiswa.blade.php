<div class="modal fade" id="createmahasiswa" tabindex="-1" role="dialog" aria-labelledby="createmahasiswaLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="createmahasiswaLabel">Add Student</h5>
        ...
        <form action="{{ route('mahasiswa.create') }}" method="POST"> 
            ...
            <div class="modal-body container-fluid"> 
                <div class="mb-3"> 
                    ...
                    <input autocomplete="off" type="" class="form-control @error('role_status') is-invalid @enderror" id="role_status" name="role_status" placeholder="Student" value="mahasiswa" readonly> 
